...
public class EquipoForm extends JPanel {
    ...
    public EquipoForm(){
        ...
        ed.add(new JLabel("Codigo inventario:")); ed.add(txtCodigo);
        ed.add(new JLabel("Numero de serie:")); ed.add(txtNumeroSerie);
        ...
        filtros.setBorder(BorderFactory.createTitledBorder("Busqueda / Filtros"));
